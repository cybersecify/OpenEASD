...
| `tests/unit/test_reports.py` | 33 | CSV export content/structure, PDF export (mocked pisa), min_severity filter, per-severity count aggregation, issue grouping, scope/CWE/CVSS/risk enrichment |
...
**Total: 982 tests** (941 fast + 41 slow domain_security)
