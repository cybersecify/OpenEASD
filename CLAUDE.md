...
| `tests/unit/test_reports.py` | 34 | CSV export content/structure, PDF export (mocked pisa), min_severity filter, per-severity count aggregation, issue grouping, scope/CWE/CVSS/risk enrichment |
