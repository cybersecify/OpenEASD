...
| `tests/unit/test_reports.py` | 27 | CSV export content/structure, PDF export (mocked pisa), min_severity filter, per-severity count aggregation |
...
**Total: 976 tests** (935 fast + 41 slow domain_security)
