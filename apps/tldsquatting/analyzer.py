...
carries, and the technique that produced it (``tld_swap`` or ``typo``), so a
defender can prioritise monitoring, defensive registration, or a takedown.
"""
...
def analyze(session, results) -> list[Finding]:
    ...
    for record in results or []:
        ...
        # organizations' own names. Mentions stay a medium-level review signal.
