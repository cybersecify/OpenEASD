...
class TestCreateSubscanSession:
    ...
    def test_creates_subscan_with_pending_status(self, db):
        from apps.core.engine.scans.pipeline import create_subscan_session
...
class TestCopyAssetsFromParent:
    ...
    def test_assets_copied_to_subscan_session(self, db):
        from apps.core.engine.scans.pipeline import create_subscan_session, _copy_assets_from_parent
        from apps.core.data.assets.models import Subdomain, IPAddress, Port
        from apps.core.data.web_assets.models import URL
